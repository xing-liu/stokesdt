/**
 * @file   verlet_r.cc
 * @brief  VerletListR class implementation
 */
...
void VerletListR::InitSearchIdx()
{
    int nc1 = get_nc1();
...
int VerletListR::InitPairs(const double *rdi,
...
int VerletListR::FindPairs(const double *pos,
                           const double *rdi,
                           std::vector<std::vector<int> > *pairs)
{  
    int nnz = 0;    
...
VerletListR::VerletListR(const int npos,
                         const double *rdi,
