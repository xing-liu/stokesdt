/**
 * @file   pair_s.cc
 * @brief  PairListS class implementation
 */
...
int PairListS::InitPairs(const double *rdi,
...
int PairListS::FindPairs(const double *pos,
                           const double *rdi,
                           std::vector<std::vector<int> > *pairs)
{
    int nnz = 0;
...
PairListS::PairListS(const int npos,
                         const double *rdi,
